...
| Structural record → a generated record, shared by shape | Implemented; one class per distinct sorted `(label, type)` shape, concretely typed, accessors named after their Flix label |
