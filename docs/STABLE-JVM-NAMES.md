...
Its first phase provides the key encoding and immutable name table. The table
...
Run `./mill --no-server flix.test.testOnly
ca.uwaterloo.flix.language.phase.jvm.TestJvmNameTable` on Java 21 or newer.
