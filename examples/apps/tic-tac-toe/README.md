...
- **Interactive GUI (Processing Core)**:
  ...
  - Natural 240ms pacing for computer moves.
...
- `src/Gui.flix`: Interactive Processing Core (`PApplet`) GUI mode with real-time canvas rendering, mouse handling, and 240ms AI move pacing.
