...
class TestJvmLexicalOrigins extends AnyFunSuite with TestUtils {
  ...
  test("golden anonymous constructor and method origins and traversal order") {
    ...
    assert(actual == List(
      ...
      "entry:Lambda:lexical-lambda:1JUJnHQcAwOmiBc9KH8X975mZEu4AE5Jh6sFLpBKvNU=",
      ...
      "all:Lambda:lexical-lambda:1JUJnHQcAwOmiBc9KH8X975mZEu4AE5Jh6sFLpBKvNU=",
      "all:Var:lexical-expression:HejM4xf4NkuY/RuY3sBm3sFiC6Krj+fFb7OCuEj2itI=",
