...
object Library {
  ...
  val StandardLibrary: List[(String, String)] = List(
    ...
    "Concurrent/Options.flix" -> LocalResource.get("/src/library/Concurrent/Options.flix"),
    ...
    "Util.flix" -> LocalResource.get("/src/library/Util.flix"),
    "Util/Checksum.flix" -> LocalResource.get("/src/library/Util/Checksum.flix"),
    "Util/Codec.flix" -> LocalResource.get("/src/library/Util/Codec.flix"),
    "Util/GetOpt.flix" -> LocalResource.get("/src/library/Util/GetOpt.flix"),
    "Util/Json.flix" -> LocalResource.get("/src/library/Util/Json.flix"),
    "Util/Json/FromJson.flix" -> LocalResource.get("/src/library/Util/Json/FromJson.flix"),
    "Util/Json/JsonError.flix" -> LocalResource.get("/src/library/Util/Json/JsonError.flix"),
    "Util/Json/JsonPath.flix" -> LocalResource.get("/src/library/Util/Json/JsonPath.flix"),
    "Util/Json/ToJson.flix" -> LocalResource.get("/src/library/Util/Json/ToJson.flix"),
