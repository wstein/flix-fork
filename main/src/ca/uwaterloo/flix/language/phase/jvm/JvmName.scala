...
object JvmName {
  ...
  /** Constructs a concatenated JVM class name using `JvmName.Delimiter`. */
  ...
  val JavaLangRuntime: List[String] = List("java", "lang", "runtime")
  ...
  val JavaList: JvmName = JvmName(JavaUtil, "List")
  val ArrayList: JvmName = JvmName(JavaUtil, "ArrayList")
  val Collections: JvmName = JvmName(JavaUtil, "Collections")
  ...
  val ObjectMethods: JvmName = JvmName(JavaLangRuntime, "ObjectMethods")
  ...
  val Record: JvmName = JvmName(JavaLang, "Record")
  ...
  val TypeDescriptor: JvmName = JvmName(JavaLangInvoke, "TypeDescriptor")
