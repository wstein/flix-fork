...
- Line probes cover function bodies, `let` bindings, statement expressions, `if` conditions and bodies, calls, binary expressions, tuples, and lambda construction; full expression-level line coverage is not implemented.
